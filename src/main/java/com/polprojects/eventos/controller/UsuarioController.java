...
public class UsuarioController {
    ...
    @GetMapping
    public List<Usuario> listar() { return usuarioService.mostrarUsuarios(); }

    @PostMapping("/registrarUsuario")
    public Usuario crear(@RequestBody Usuario usuario) { return usuarioService.guardarUsuario(usuario); }
